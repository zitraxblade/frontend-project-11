...
const renderFeeds = () => {
  ...
  state.feeds.forEach((feed) => feedsContainer.appendChild(createFeedCard(feed)));
};

const createFeedCard = (feed) => {
...
const renderPosts = () => {
  ...
  state.posts.forEach((post) => postsContainer.appendChild(createPostDiv(post)));
};
